...
const Header = () => {
  ...
  return (
    <section className="w-full sm:w-16 h-14 sm:h-full bg-slate-200 dark:bg-slate-800 flex flex-row items-center justify-evenly sm:justify-start sm:flex-col shrink-0">
      <HeaderButton
